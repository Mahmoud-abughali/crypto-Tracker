...
export const CryptoCard = ({ crypto }) => {
  console.log("price:", crypto.current_price, typeof crypto.current_price);
    ...
    <Link to={`/coin/${crypto.id}`} style={{ textDecoration: "none" }}>
      <div className="crypto-card">
        ...
        <div className="crypto-price">
          <p className="price">{formatPrice(Number(crypto.current_price))}</p>
          <p
        ...
        <div className="crypto-stats">
          ...
          <div className="stat">
            <span className="stat-label">Volum</span>
            <span className="stat-value">
